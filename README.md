...
* Readings from outside the textbook are in [`readings/`](/readings/)
* Problem sets will be posted and submitted in subdirectories of [`ps/`](/ps/)

## Problem Sets

In order to submit your solutions, please upload a `.txt` file or a `.R` or `.qmd`
or `.Rmd` 
...
Please name your file, e.g., `ps1_Moore.R`, `ps2_Moore.R`, with no spaces, and 
separating the problem set number from your surname with an underscore (`_`).
