...
\noindent T A\\
Email: {\tt } (at) {\tt gmail} (dot) {\tt com} \\
Office hours: 08:30-09:30 BST (UTC+01:00) \\
Available through Zoom account {\tt } (at) {\tt essex} (dot) {\tt ac} (dot) {\tt uk}
...
\item Check out Mission Cafe in the Innovation Centre.
\end{itemize}
